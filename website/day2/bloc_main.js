	...
	var feedback = {
		...
		stimulus: function(data) {
			...
			if (choice <= 1){
				...
				//feedback_text = `<table width=100%><tr><td>` + feedback_chosen_arm + `</td><td>` + feedback_taken_arm + `</td></tr></table>`;
				feedback_text = `<p>` + feedback_chosen_arm + `<span style="display:inline-block; width: 100px;"></span>` + feedback_taken_arm + `</p>`; 
				//feedback_text = `<p>` + feedback_chosen_arm + `&emsp;&emsp;&emsp;&emsp;` + feedback_taken_arm + `</p>`; 
				//feedback_instructions = `<p style='color:` + taken_color.toLowerCase() + `;'>If ` + chosen_color.toLowerCase() + ` was the correct light, you will have earned a coin</p>`
