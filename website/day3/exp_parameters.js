function returnExperimentParameters() {
    let params = {
        ...
        path_data: 'tasks/kai/HumanObserveBetEfficacyDay3Of3/data/',
        temp_path_data: 'tasks/kai/HumanObserveBetEfficacyDay3Of3/data/temp/',
        resize_path_data: 'tasks/kai/HumanObserveBetEfficacyDay3Of3/data/resize/',
