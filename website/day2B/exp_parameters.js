function returnExperimentParameters() {
    let params = {
        ...
        path_data: 'tasks/kai/HumanObserveBetEfficacyDay2Of2B/data/',
        temp_path_data: 'tasks/kai/HumanObserveBetEfficacyDay2Of2B/data/temp/',
        resize_path_data: 'tasks/kai/HumanObserveBetEfficacyDay2Of2B/data/resize/',
